import type { EnergyLevel, FamiliarityLevel, SocialSharpness, TheatricalIntensity } from "./common.js";
export type CompanionMode = "host" | "narrator" | "hype" | "savage_commentator" | "judge_verdict" | "chill_recap" | "challenge_master" | "continuity_keeper";
export type CompanionStance = "welcoming" | "observant" | "playful" | "theatrical" | "supportive_light" | "socially_sharp" | "continuity_inviting";
