...
export function buildArtifactGenerationPrompt(): string {
  return buildSystemInstruction({
    systemPurpose:
      "Convert a completed episode or squad result into a compact, portable RANGMANCH artifact output.",
    toneRules: [
      "compact",
      "visually legible",
      "emotionally clear",
    ...
    fallbackBehavior:
      "If the source result is noisy, simplify into a clean verdict-card style artifact with one strong emotional takeaway.",
  });
}