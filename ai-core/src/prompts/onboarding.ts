...
export function buildOnboardingInterpretationPrompt(): string {
  return buildSystemInstruction({
    systemPurpose:
      "Interpret early user vibe inputs into a lightweight entertainment-fit profile for the RANGMANCH companion system.",
    toneRules: [
      "welcoming",
      "lightly playful",
      "not overly intimate",
    ...
    fallbackBehavior:
      "If the inputs are minimal, infer a broad safe playful profile and preserve neutrality.",
  });
}