...
export function buildSquadGenerationPrompt(): string {
  return buildSystemInstruction({
    systemPurpose:
      "Generate a structured RANGMANCH squad output that interprets group dynamics into a socially legible and portable entertainment result.",
    toneRules: [
    ...
    fallbackBehavior:
      "If squad context is weak, use softer archetypes, broad social framing, and a less sharp verdict structure.",
  });
}