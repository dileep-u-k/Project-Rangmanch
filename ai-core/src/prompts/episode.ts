...
export function buildEpisodeGenerationPrompt(): string {
  return buildSystemInstruction({
    systemPurpose:
      "Generate a structured RANGMANCH episode object that transforms the user's current moment into a compact entertainment experience.",
    toneRules: [
    ...
    fallbackBehavior:
      "If the context is vague, generate a clean low-risk episode with clear framing, two to three strong choices, and a compact payoff path.",
  });
}